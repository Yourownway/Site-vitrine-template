      ...
      <section className="section">
        ...
        <div className="section__part1">
          ...
          <p className="section__p1">
            ...
            d’accompagnement en tant qu’<span>infirmière de l’âme afin</span> de
            vous apporter les messages qui vous guideront et apporteront de la
            ...
            la paix en Soi. C’est avec grand plaisir que je vous accompagne afin
            de vous aider à comprendre la racine de votre problématique, de vous
            donner les clefs pour la gérer, et d’obtenir les messages de vos
            guides.
          </p>{" "}
        </div>
      </section>
